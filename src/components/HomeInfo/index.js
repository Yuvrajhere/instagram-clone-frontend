...
const HomeInfo = () => {
  ...
  useEffect(() => {
    const interval = setInterval(function() {
      setShowcaseImageNumber(showcaseImageNumber => ( showcaseImageNumber + 1 ) % 5);
    }, 4000);
  ...
  return (
    <div className="HomeInfo flex-column justify-btwn">
      <main className="flex align-center">
        <div>
          <img className={showcaseImageNumber !== 0 ? "hide-image" : ""} id="showcase-img" src={imageList[0]} alt />
          <img className={showcaseImageNumber !== 1 ? "hide-image" : ""} id="showcase-img" src={imageList[1]} alt />
          <img className={showcaseImageNumber !== 2 ? "hide-image" : ""} id="showcase-img" src={imageList[2]} alt />
          <img className={showcaseImageNumber !== 3 ? "hide-image" : ""} id="showcase-img" src={imageList[3]} alt />
          <img className={showcaseImageNumber !== 4 ? "hide-image" : ""} id="showcase-img" src={imageList[4]} alt />
        </div>
        <section className="flex-column justify-btwn align-center">
          <form className="flex-column justify-btwn align-center">
            <h1>Instagram</h1>
            <div className={isInputSelected.user || userDetails.user ? "active" : ""}>
            ...
            <div className={isInputSelected.password || userDetails.password ? "active" : ""}>
            ...
            <p>OR</p>
            <p className="fb-login-link" ><i className="fab fa-facebook-square"></i> Log in with Facebook</p>
            <a>Forgot password?</a>
          </form>
